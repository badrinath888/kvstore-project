...
class KeyValueStore:
    ...
    def set(self, key: str, value: str) -> None:
        ...
        safe_key = key.encode("utf-8", errors="replace").decode("utf-8", errors="replace")
        safe_value = value.encode("utf-8", errors="replace").decode("utf-8", errors="replace")
        try:
...
def _write_line(text: str) -> None:
    # Sanitize all output: ensure valid UTF-8
